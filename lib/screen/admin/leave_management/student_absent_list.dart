...
class StudentAbsentList extends StatefulWidget {
  const StudentAbsentList({super.key});

  @override
  _StudentAbsentListState createState() => _StudentAbsentListState();
}

class _StudentAbsentListState extends State<StudentAbsentList> {
