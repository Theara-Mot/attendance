...
class _StudentListState extends State<StudentList> {
  ...
  Widget build(BuildContext context) {
    ...
    int totalStaff = studentList.length;
    int maleCount = 0;
    int femaleCount = 0;
    for (var staff in studentList) {
    ...
    return BuildAppBar(title: 'student_list',
        bodyWidget: Padding(
                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                decoration: BoxDecoration(
                                  color: selectedGrade == grade[index]
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(totalStaff.toString(),style: AppFont.largBold()),
                        SizedBox(height:AppDimension.height10),
